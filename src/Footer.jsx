function Footer() {
  return (
    <footer className="bg-slate-100 pt-16 pb-8 px-4 md:px-8 ">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-6 sm:gap-x-8 mt-12">
        <div className="space-y-6">
          <h3 className="text-slate-900 font-semibold text-sm">Services</h3>
        ...
        <div className="space-y-6">
          <h3 className="text-slate-900 font-semibold text-sm">Platforms</h3>
          <ul className="space-y-4 text-sm text-slate-600 font-normal">
            <li>
              <a
                href="#"
        ...
        <div className="space-y-6">
          <h3 className="text-slate-900 font-semibold text-sm">Company</h3>
          <ul className="space-y-4 text-sm text-slate-600 font-normal">
            <li>
              <a
                href="#"
        ...
        <div className="space-y-6">
          <h3 className="text-slate-900 font-semibold text-sm">Additional</h3>
          <ul className="space-y-4 text-sm text-slate-600 font-normal">
            <li>
              <a
                href="#"
      ...
      <div className="flex flex-wrap gap-4 flex-col md:flex-row">
        <ul className="flex flex-wrap gap-4 text-sm text-slate-600 font-normal">
          <li>
            <a
              href="#"
              className="hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded transition-all"
