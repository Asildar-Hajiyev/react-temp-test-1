        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-4 w-full">
          ...
          <div className="flex items-center justify-between w-full md:w-auto gap-4 flex-1">
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <Link
                to="/"
                className="text-xl sm:text-2xl text-blue-400 font-semibold truncate whitespace-nowrap"
              >
                Brend To Ecommerce
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4 shrink-0 md:hidden">
              <div className="flex flex-col items-center justify-center cursor-pointer text-slate-900 hover:text-blue-700">
                <div className="relative">
                  ...
                  <span className="absolute -top-1 -right-1.5 rounded-full bg-red-500 px-1 text-[10px] text-white font-medium">
                    2
                  </span>
                </div>
              </div>
          ...
          <div
            id="collapseMenu"
            className="hidden lg:block outline-none mx-auto"
          >
            <ul className="flex gap-8 font-semibold text-sm text-slate-900 lg:flex-row">
              <li>
                <Link to="/" className="hover:text-blue-700 rounded">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/blog" className="hover:text-blue-700 rounded">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/about" className="hover:text-blue-700 rounded">
                  About
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover:text-blue-700 rounded">
                  Contact
                </Link>
              </li>
              <li>
                <Link to="/todo" className="hover:text-blue-700 rounded">
                  To Do
                </Link>
              </li>
              <li>
                <Link to="/products" className="hover:text-blue-700 rounded">
                  Products
                </Link>
              </li>
              <li>
                <Link to="/user" className="hover:text-blue-700 rounded">
                  User
                </Link>
              </li>
            </ul>
            ...
            <div className="hidden md:flex items-center gap-4">
              <div className="flex flex-col items-center justify-center cursor-pointer text-[13px] font-semibold text-slate-900 hover:text-blue-700">
                <div className="relative">
                  ...
                  <span className="absolute -top-0.5 -right-2 rounded-full bg-red-500 px-1 text-xs text-white font-medium">
                    2
                  </span>
                </div>
                <span>Wishlist</span>
              ...
              <div
                ...
                className="flex flex-col items-center justify-center cursor-pointer text-[13px] font-semibold text-slate-900 hover:text-blue-700"
              >
                <div className="relative">
          ...
          {open && (
            ...
            >
              <div
                className="bg-orange-400 w-full max-w-[300px] sm:max-w-[400px] h-full p-6 shadow-xl flex flex-col justify-between"
        ...
        >
          ...
          >
            <div className="flex items-center pb-3 border-b border-slate-300">
              <h3
                id="modal-title"
                className="text-slate-900 text-lg font-semibold flex-1"
              >
                Səbət
              </h3>
              ...
              {sebet.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <button className="w-8 h-8 rounded-lg border">-</button>

                    <span className="font-semibold">{item.count}</span>

                    <button className="w-8 h-8 rounded-lg bg-slate-900 text-white">
                      +
                    </button>
                  </div>
            ...
            <div className="border-t border-slate-300 pt-4 flex justify-end gap-4 md:pt-6">
              <button
                type="button"
                id="cancelBtn"
                onClick={() => setOpenCart(!openCart)}
                className="px-3.5 py-2 text-slate-900 text-sm font-semibold rounded-md cursor-pointer bg-white border border-slate-300 transition-colors hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                Cancel
              </button>
            </div>
